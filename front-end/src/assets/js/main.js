(function ($) {
    ...
    /*===========================
        Tab sliders active
    ===========================*/
    $('.tab-sliders-images').slick({
        fade: true,
        arrows: false,
        dots: true,
        asNavFor: '.tab-sliders-nav',

    });
    // tab sliders nav active
    $('.tab-sliders-nav').slick({
        slidesToShow: 3,
        asNavFor: '.tab-sliders-images',
        centerMode: true,
        centerPadding: 0,
        dots: true,
        focusOnSelect: true,
    ...
    /*=================================
       Product Details sliders active
    ===================================*/
    $('.product-large-sliders').slick({
        fade: false,
        arrows: true,
    ...
    // product details sliders nav active
    $('.product-nav').slick({
        slidesToShow: 4,
        asNavFor: '.product-large-sliders',
        centerMode: true,
        centerPadding: 0,
        focusOnSelect: true,
        prevArrow: '<button type="button" class="slick-prev"><i class="far fa-angle-left"></i></button>',
    ...
    var carouselSlider = new Swiper('.branding-preview-sliders', {
        slidesPerView : 1,
        slidesPerGroup: 1,
        loop: true,
        speed: 1000,
    ...
    var carouselSlider = new Swiper('.app-landing-testimonial-sliders', {
        slidesPerView : 1,
        slidesPerGroup: 1,
        loop: true,
        speed: 1000,
    ...
    /*=====  End of swiper sliders activation  ======*/
    });
